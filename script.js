...
function syncExportLayout() {
  ...
  if (exportRarityPill) {
    ...
    exportRarityPill.style.height = "auto";
    exportRarityPill.style.minHeight = "2rem";
    exportRarityPill.style.lineHeight = "1";
    exportRarityPill.style.letterSpacing = "0.35em";
  }
}
